      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
          ...
          >
            ...
            {/* Instagram */}
            <motion.a
              href="https://www.instagram.com/mac_visualsedits?igsh=Zm1iZnFuMWV2eGdu"
              target="_blank"
            ...
            >
              ...
              <span className="hidden sm:block">@mac_visualsedits</span>
            </motion.a>

            {/* TikTok */}
            <motion.a
              href="https://www.tiktok.com/@mac_visuals_?_t=ZS-901lDKYIRJh&_r=1"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center space-x-2 text-gray-300 hover:text-white transition-colors group"
              whileHover={{ scale: 1.05, y: -2 }}
            ...
            >
              ...
              <span className="hidden sm:block">@mac_visuals_</span>
            </motion.a>
          </motion.div>
        </div>
